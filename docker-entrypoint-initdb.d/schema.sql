...
-- Create ENUM types
CREATE TYPE IF NOT EXISTS user_role AS ENUM ('ADMIN', 'OPERATOR');
CREATE TYPE IF NOT EXISTS vehicle_status_enum AS ENUM ('ACTIVE', 'INACTIVE', 'MAINTENANCE');
CREATE TYPE IF NOT EXISTS traffic_density_enum AS ENUM ('LOW', 'MEDIUM', 'HIGH');
CREATE TYPE IF NOT EXISTS incident_type_enum AS ENUM ('ACCIDENT', 'CONSTRUCTION', 'ROAD_CLOSED', 'CONGESTION');
CREATE TYPE IF NOT EXISTS incident_status_enum AS ENUM ('REPORTED', 'IN_PROGRESS', 'RESOLVED');
CREATE TYPE IF NOT EXISTS notification_type_enum AS ENUM ('INCIDENT', 'TRAFFIC_ALERT', 'VEHICLE_UPDATE', 'SYSTEM');
...
CREATE INDEX IF NOT EXISTS idx_vehicle_timestamp ON gps_locations ("vehicleId", timestamp);
